...
trait TestData extends BaseService {
  ...
  val setup = DBIO.seq(
    ...
    questionsTable += Question(None, 1, "subject1", "First Test Question \\o/", "preparation", "freetext", FormatAttributes(Map()), None),
    questionsTable += Question(None, 1, "subject2", "Second Question. Isn't that nice?", "preparation", "freetext", FormatAttributes(Map()), None),
    questionsTable += Question(None, 1, "subject3", "First lecture question", "lecture", "freetext", FormatAttributes(Map()), None),
    questionsTable += Question(None, 1, "subject4", "Test Data isn't my thing", "lecture", "flashcard",
      FormatAttributes(Map("backside" -> "this is a backside. I'm making a note here: huge success!")), None),
    questionsTable += Question(None, 1, "subject5", "Last but not least", "lecture", "mc", FormatAttributes(Map()), None),
    questionsTable += Question(None, 1, "subject1", "First Question on second session", "lecture", "mc", FormatAttributes(Map()), None),
